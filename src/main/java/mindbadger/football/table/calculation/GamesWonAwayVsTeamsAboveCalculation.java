...
public class GamesWonAwayVsTeamsAboveCalculation extends CalculationForFixture<String, String, String> {
	public GamesWonAwayVsTeamsAboveCalculation(Team team, Fixture fixture, TeamFixtureContext fixtureTeamContext, TeamFixtureContext oppositionTeamContext, TableRow previousTableRow) {
	...
	public int calculate(boolean reCalculate) {
		...
		return ((won && !fixtureTeamContext.isAtHome() && fixtureTeamContext.isPlayingTeamAbove()) ?
				previousTableRow.getAttribute(GAMES_WON_AWAY_VS_ABOVE) + 1 : previousTableRow.getAttribute(GAMES_WON_AWAY_VS_ABOVE));
	}
