...
public class GamesDrawnAwayVsTeamsAboveCalculation extends CalculationForFixture<String, String, String> {
	public GamesDrawnAwayVsTeamsAboveCalculation(Team<String> team, Fixture<String> fixture, TeamFixtureContext fixtureTeamContext, TeamFixtureContext oppositionTeamContext, TableRow<String,String,String> previousTableRow) {
	...
	public int calculate(boolean reCalculate) {
		...
		return ((drawn && !fixtureTeamContext.isAtHome() && fixtureTeamContext.isPlayingTeamAbove()) ?
				previousTableRow.getAttribute(TableRow.GAMES_DRAWN_AWAY_VS_ABOVE) + 1 : previousTableRow.getAttribute(TableRow.GAMES_DRAWN_AWAY_VS_ABOVE));
	}
