...
public class GamesWonAtHomeCalculation extends CalculationForFixture<String, String, String> {
	public GamesWonAtHomeCalculation(Team<String> team, TableRow<String,String,String> previousTableRow, Fixture<String> fixture) {
	...
	public int calculate(boolean reCalculate) {
		...
		if (previousTableRow != null) {
			previousGamesWon = previousTableRow.getAttribute(TableRow.GAMES_WON_AT_HOME);
		}
