...
public class GamesWonAwayCalculation extends CalculationForFixture<String, String, String> {
	public GamesWonAwayCalculation(Team<String> team, TableRow<String,String,String> previousTableRow, Fixture<String> fixture) {
