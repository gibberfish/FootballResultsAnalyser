...
public class GoalsConcededInDrawsAwayVsTeamsAboveCalculation extends CalculationForFixture<String, String, String> {
	public GoalsConcededInDrawsAwayVsTeamsAboveCalculation(Team<String> team, Fixture<String> fixture, TeamFixtureContext fixtureTeamContext, TeamFixtureContext oppositionTeamContext, TableRow<String,String,String> previousTableRow) {
	...
	public int calculate(boolean reCalculate) {
		...
		return ((drawn && !fixtureTeamContext.isAtHome() && fixtureTeamContext.isPlayingTeamAbove()) ?
				previousTableRow.getAttribute(TableRow.GOALS_CONCEDED_IN_DRAWS_AWAY_VS_ABOVE) + goalsAgainst : previousTableRow.getAttribute(TableRow.GOALS_CONCEDED_IN_DRAWS_AWAY_VS_ABOVE));
	}
