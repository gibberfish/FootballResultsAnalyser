...
public class GoalsScoredInDrawsAwayVsTeamsAboveCalculation extends CalculationForFixture<String, String, String> {
	public GoalsScoredInDrawsAwayVsTeamsAboveCalculation(Team<String> team, Fixture<String> fixture, TeamFixtureContext fixtureTeamContext, TeamFixtureContext oppositionTeamContext, TableRow<String,String,String> previousTableRow) {
	...
	public int calculate(boolean reCalculate) {
		...
		return ((drawn && !fixtureTeamContext.isAtHome() && fixtureTeamContext.isPlayingTeamAbove()) ?
				previousTableRow.getAttribute(TableRow.GOALS_SCORED_IN_DRAWS_AWAY_VS_ABOVE) + goalsFor : previousTableRow.getAttribute(TableRow.GOALS_SCORED_IN_DRAWS_AWAY_VS_ABOVE));
	}
