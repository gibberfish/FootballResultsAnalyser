...
import mindbadger.footballresults.table.calculation.AttributeDefinition;
...
public class CalculationMapFactoryTest {
	...
	public void shouldCreateACalculationMapFromValidConfiguration () {
		...
		goalsScoredDefinition.setCalculationClass("mindbadger.footballresults.table.calculation.GoalsScoredCalculation");
		goalsScoredDefinition.setSequence(1);

		AttributeDefinition goalsConcededDefinition = new AttributeDefinition ();
		goalsConcededDefinition.setCalculationClass("mindbadger.footballresults.table.calculation.GoalsConcededCalculation");
		goalsConcededDefinition.setSequence(2);

		AttributeDefinition goalDifferenceDefinition = new AttributeDefinition ();
		goalDifferenceDefinition.setCalculationClass("mindbadger.footballresults.table.calculation.GoalDifferenceCalculation2");
		goalDifferenceDefinition.setSequence(3);

		AttributeDefinition goalDifferenceDefinition2 = new AttributeDefinition ();
		goalDifferenceDefinition2.setCalculationClass("mindbadger.footballresults.table.calculation.DynamicCalculation");
