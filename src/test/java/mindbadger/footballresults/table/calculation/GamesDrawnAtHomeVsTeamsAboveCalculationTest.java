...
import mindbadger.footballresults.table.calculation.GamesDrawnAtHomeVsTeamsAboveCalculation;
...
public class GamesDrawnAtHomeVsTeamsAboveCalculationTest {
	private GamesDrawnAtHomeVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_DRAWN_AT_HOME_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GamesDrawnAtHomeVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
