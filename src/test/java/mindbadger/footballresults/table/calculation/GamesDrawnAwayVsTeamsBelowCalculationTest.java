...
import mindbadger.footballresults.table.calculation.GamesDrawnAwayVsTeamsBelowCalculation;
...
public class GamesDrawnAwayVsTeamsBelowCalculationTest {
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_DRAWN_AWAY_VS_BELOW)).thenReturn(3);
