...
import mindbadger.footballresults.table.calculation.GamesLostAtHomeVsTeamsBelowCalculation;
...
public class GamesLostAtHomeVsTeamsBelowCalculationTest {
	private GamesLostAtHomeVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_LOST_AT_HOME_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GamesLostAtHomeVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
