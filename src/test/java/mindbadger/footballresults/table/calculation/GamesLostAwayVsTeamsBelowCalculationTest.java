...
import mindbadger.footballresults.table.calculation.GamesLostAwayVsTeamsBelowCalculation;
...
public class GamesLostAwayVsTeamsBelowCalculationTest {
	private GamesLostAwayVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_LOST_AWAY_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GamesLostAwayVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
