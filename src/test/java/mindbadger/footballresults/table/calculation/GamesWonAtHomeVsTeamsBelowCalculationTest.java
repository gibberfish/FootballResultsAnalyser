...
import mindbadger.footballresults.table.calculation.GamesWonAtHomeVsTeamsBelowCalculation;
...
public class GamesWonAtHomeVsTeamsBelowCalculationTest {
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_WON_AT_HOME_VS_BELOW)).thenReturn(3);
