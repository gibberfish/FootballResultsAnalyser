...
import mindbadger.footballresults.table.calculation.GamesWonAwayVsTeamsAboveCalculation;
...
public class GamesWonAwayVsTeamsAboveCalculationTest {
	private GamesWonAwayVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_WON_AWAY_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GamesWonAwayVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
