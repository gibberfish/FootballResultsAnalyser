...
import mindbadger.footballresults.table.calculation.GamesWonAwayVsTeamsBelowCalculation;
...
public class GamesWonAwayVsTeamsBelowCalculationTest {
	private GamesWonAwayVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GAMES_WON_AWAY_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GamesWonAwayVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
