...
import mindbadger.footballresults.table.calculation.GoalsConcededInDefeatsAtHomeVsTeamsBelowCalculation;
...
public class GoalsConcededInDefeatsAtHomeVsTeamsBelowCalculationTest {
	private GoalsConcededInDefeatsAtHomeVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_CONCEDED_IN_DEFEATS_AT_HOME_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GoalsConcededInDefeatsAtHomeVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
