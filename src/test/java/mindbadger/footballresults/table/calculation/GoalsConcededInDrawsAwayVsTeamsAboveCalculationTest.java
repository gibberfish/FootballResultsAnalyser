...
import mindbadger.footballresults.table.calculation.GoalsConcededInDrawsAwayVsTeamsAboveCalculation;
...
public class GoalsConcededInDrawsAwayVsTeamsAboveCalculationTest {
	private GoalsConcededInDrawsAwayVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_CONCEDED_IN_DRAWS_AWAY_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsConcededInDrawsAwayVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
