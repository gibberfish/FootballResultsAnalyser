...
import mindbadger.footballresults.table.calculation.GoalsConcededInDrawsAwayVsTeamsBelowCalculation;
...
public class GoalsConcededInDrawsAwayVsTeamsBelowCalculationTest {
	private GoalsConcededInDrawsAwayVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_CONCEDED_IN_DRAWS_AWAY_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GoalsConcededInDrawsAwayVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
