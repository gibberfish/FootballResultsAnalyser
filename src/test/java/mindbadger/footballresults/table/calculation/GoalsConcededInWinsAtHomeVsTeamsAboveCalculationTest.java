...
import mindbadger.footballresults.table.calculation.GoalsConcededInWinsAtHomeVsTeamsAboveCalculation;
...
public class GoalsConcededInWinsAtHomeVsTeamsAboveCalculationTest {
	private GoalsConcededInWinsAtHomeVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnAnIncrementWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_CONCEDED_IN_WINS_AT_HOME_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsConcededInWinsAtHomeVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
