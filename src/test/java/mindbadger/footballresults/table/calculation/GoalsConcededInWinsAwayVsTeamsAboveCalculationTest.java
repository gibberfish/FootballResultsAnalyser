...
import mindbadger.footballresults.table.calculation.GoalsConcededInWinsAwayVsTeamsAboveCalculation;
...
public class GoalsConcededInWinsAwayVsTeamsAboveCalculationTest {
	private GoalsConcededInWinsAwayVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_CONCEDED_IN_WINS_AWAY_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsConcededInWinsAwayVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
	...
	@Test
	public void shouldReturnAnIncrementWhenThereIsAPreviousRowForAnAwayWinAgainstATeamAbove () {
		// Given
