...
import mindbadger.footballresults.table.calculation.GoalsScoredInDefeatsAtHomeVsTeamsAboveCalculation;
...
public class GoalsScoredInDefeatsAtHomeVsTeamsAboveCalculationTest {
	private GoalsScoredInDefeatsAtHomeVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_DEFEATS_AT_HOME_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInDefeatsAtHomeVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
