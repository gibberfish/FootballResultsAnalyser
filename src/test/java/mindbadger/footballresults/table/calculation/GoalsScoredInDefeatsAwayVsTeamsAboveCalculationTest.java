...
import mindbadger.footballresults.table.calculation.GoalsScoredInDefeatsAwayVsTeamsAboveCalculation;
...
public class GoalsScoredInDefeatsAwayVsTeamsAboveCalculationTest {
	private GoalsScoredInDefeatsAwayVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_DEFEATS_AWAY_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInDefeatsAwayVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
