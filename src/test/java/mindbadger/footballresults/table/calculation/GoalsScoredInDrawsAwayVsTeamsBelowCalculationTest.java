...
import mindbadger.footballresults.table.calculation.GoalsScoredInDrawsAwayVsTeamsBelowCalculation;
...
public class GoalsScoredInDrawsAwayVsTeamsBelowCalculationTest {
	private GoalsScoredInDrawsAwayVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_DRAWS_AWAY_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInDrawsAwayVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
