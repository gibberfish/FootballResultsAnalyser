...
import mindbadger.footballresults.table.calculation.GoalsScoredInWinsAtHomeVsTeamsAboveCalculation;
...
public class GoalsScoredInWinsAtHomeVsTeamsAboveCalculationTest {
	private GoalsScoredInWinsAtHomeVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnAnIncrementWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_WINS_AT_HOME_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInWinsAtHomeVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
