...
import mindbadger.footballresults.table.calculation.GoalsScoredInWinsAtHomeVsTeamsBelowCalculation;
...
public class GoalsScoredInWinsAtHomeVsTeamsBelowCalculationTest {
	private GoalsScoredInWinsAtHomeVsTeamsBelowCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_WINS_AT_HOME_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInWinsAtHomeVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
