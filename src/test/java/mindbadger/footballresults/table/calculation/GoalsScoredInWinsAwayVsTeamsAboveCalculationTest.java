...
import mindbadger.footballresults.table.calculation.GoalsScoredInWinsAwayVsTeamsAboveCalculation;
...
public class GoalsScoredInWinsAwayVsTeamsAboveCalculationTest {
	private GoalsScoredInWinsAwayVsTeamsAboveCalculation objectUnderTest;
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_WINS_AWAY_VS_ABOVE)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInWinsAwayVsTeamsAboveCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
