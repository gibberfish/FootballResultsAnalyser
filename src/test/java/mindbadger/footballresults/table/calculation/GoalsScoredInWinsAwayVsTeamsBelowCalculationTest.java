...
import mindbadger.footballresults.table.calculation.GoalsScoredInWinsAwayVsTeamsBelowCalculation;
...
public class GoalsScoredInWinsAwayVsTeamsBelowCalculationTest {
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWinAgainstATeamAbove () {
		...
		when (mockPreviousTableRow.getAttribute(GOALS_SCORED_IN_WINS_AWAY_VS_BELOW)).thenReturn(3);
		
		objectUnderTest = new GoalsScoredInWinsAwayVsTeamsBelowCalculation(mockTeamForCalculation, mockFixture, mockFixtureTeamContext, mockOppositionTeamContext, mockPreviousTableRow);
