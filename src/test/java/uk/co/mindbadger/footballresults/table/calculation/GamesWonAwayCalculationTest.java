...
public class GamesWonAwayCalculationTest {
	private GamesWonAwayCalculation objectUnderTest;
	...
	public void shouldReturnZeroWhenThereIsNoPreviousRowForAHomeWin () {
		...
		objectUnderTest = new GamesWonAwayCalculation(mockTeam1, null, mockFixture);
	...
	@Test
	public void shouldReturnOneWhenThereIsNoPreviousRowForAnAwayWin () {
		// Given
	...
	public void shouldReturnNoChangeWhenThereIsAPreviousRowForAHomeWin () {
		...
		when (mockFixture.getHomeGoals()).thenReturn(3);
		when (mockFixture.getAwayGoals()).thenReturn(1);
		when (mockPreviousTableRow.getAttribute(TableRow.GAMES_WON_AWAY)).thenReturn(3);
		objectUnderTest = new GamesWonAwayCalculation(mockTeam1, mockPreviousTableRow, mockFixture);
